...
from utils.general import (DATASETS_DIR, clean_str, check_requirements)
...
class LoadImages:
    ...
    def __init__(self, master, path, img_size=640, stride=32, auto=True):
        ...
        if '*' in p:
            ...
            master.insert_textbox(message=f'ERROR: {p} does not exist')
...
class LoadStreams:
    ...
    def __init__(self, master, sources='streams.txt', img_size=640, stride=32, auto=True):
        self.mode = 'stream'
        self.img_size = img_size
        self.stride = stride
        ...
        for i, s in enumerate(sources):  # index, source
            ...
            if urlparse(s).hostname in ('www.youtube.com', 'youtube.com', 'youtu.be'):  # if source is YouTube video
                check_requirements(('pafy', 'git+https://github.com/Cupcakus/pafy'))
                import pafy               
            ...
            if cap.isOpened() == False :
                master.insert_textbox(message=f'Protected?\n{st}Failed to open {s}')
